...
class FilterExclude : Function {
  override fun execute(call: GnCall, targetScope: Scope): GnValue? = executeFilter(call.exprList,
      targetScope, exclude = true)
